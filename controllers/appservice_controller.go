...
import (
	"context"
	"github.com/senbird/opdemo/controllers/resources"
	...
	appv1beta1 "github.com/senbird/opdemo/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=app.unclejoke.cn,resources=appservices,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=app.unclejoke.cn,resources=appservices/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=app.unclejoke.cn,resources=appservices/finalizers,verbs=update
...
func (r *AppServiceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	logr := log.FromContext(ctx, "appservice", req.NamespacedName)
	...
	logr.Info("fetch appservice objects", "appservice", appService)
